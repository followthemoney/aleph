...
from aleph.logic.ftmstore import get_ftmstore, MODEL_ORIGIN
...
def ingest_flush(collection, entity_id=None, include_ingest=False):
    ...
    ftmstore.delete(entity_id=entity_id, origin=MODEL_ORIGIN)
    if include_ingest:
        ftmstore.delete(entity_id=entity_id, origin=OP_INGEST)
    for stage in SETTINGS.INGEST_PIPELINE:
        ftmstore.delete(entity_id=entity_id, origin=stage)
